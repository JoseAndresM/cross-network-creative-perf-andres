...
if new_file and game_code:
    ...
    if 'creative_network' not in new_data.columns:
        ...
        aggregated_data = new_data.groupby('creative_id').agg({
            ...
            'ecpi': 'mean',
            'ecpi_all': 'mean'  # Assuming ecpi_all is provided in the dataset
        }).reset_index()
        ...
        # Step 7: Calculate ROAS diff and CPI diff
        aggregated_data['ROAS_diff'] = aggregated_data['roas_d0'] - target_roas_d0
        aggregated_data['CPI_diff'] = target_cpi - aggregated_data['ecpi_all']
        ...
        # Step 10: Calculate Lumina Score with Auto-Test Analysis logic
